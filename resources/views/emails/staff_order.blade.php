...
<body>
    ...
    @endphp
     <div class="mail-conatiner">
        <p class="">Hello <b class="font-weight-bold">{{ $user_info['names']  }} </b>,</p>
        ...
        <hr>
        <div class="">
            <small>For any assistance regarding your Invoices and Delivary, <br>
                please visit Stokka Fela Tembisa Store. Or send an email to <a class="" href="mailto:info@mabebeza.com">support@stokkafela.com</a></small>
        </div> <br>
